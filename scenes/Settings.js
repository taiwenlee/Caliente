class Setting extends Phaser.Scene {
   ...
   create() {
      ...
      const musicVolumeUpButton = this.add.image(400, 300, 'button').setOrigin(0.5);
      ...
      const musicVolumeDownButton = this.add.image(200, 300, 'button').setOrigin(0.5);
      ...
      const sfxVolumeUpButton = this.add.image(400, 500, 'button').setOrigin(0.5);
      ...
      const sfxVolumeDownButton = this.add.image(200, 500, 'button').setOrigin(0.5);
